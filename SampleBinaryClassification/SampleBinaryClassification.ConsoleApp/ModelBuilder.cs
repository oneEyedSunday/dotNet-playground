...
namespace SampleBinaryClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"/Users/ispoa/Projects/DotNetPlay/data.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.ConvertType(new[] { new InputOutputColumnPair("is_quote", "is_quote") })
                                      .Append(mlContext.Transforms.Categorical.OneHotEncoding(new[] { new InputOutputColumnPair("source", "source"), new InputOutputColumnPair("lang", "lang") }))
                                      .Append(mlContext.Transforms.Text.FeaturizeText("text_tf", "text"))
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "is_quote", "source", "lang", "text_tf", "status_id", "user_id", "favourites_count", "retweet_count" }))
